...
list_page_url = 'https://hfs.illinois.gov/info/factsfigures/program-enrollment/adams.html'
...
output_file = open('adams_totalenrollment.csv','w') # file ready for writing
